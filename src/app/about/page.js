...
export default function About (){
    ...
    return (
        ...
        title="四條畷神社について"
        description=
        "四條畷市は大阪府の東北部に位置し、市の約三分の二が北生駒山地でしめられている緑豊かな場所であり、西の軽井沢と称されています。当社は飯盛山の山麓に鎮座し、忠孝両全の名将楠正行公をはじめ二十五柱の大神様をお祀りしております。"
        />
        <SubtitleVisual
        title="御由緒"
        description="　"
        ...
        <section className={styles.main}>
            ...
            <div className={styles.caption}>
                    <div className={styles.title}>
                        ...
                        <p>住吉平田神社の神主、三牧文吾氏らが楠正行公殉死のこの地に神社創建を願い出て、
                            明治22年に勅許が下り、四條畷神社という社号が下されました。
                            これを里人が大いに喜び、境内地や金品を寄進され、老も若きも土を運び、石を積んで奉仕され、 明治23年4月5日に御鎮座祭が斎行されました。
                        </p>
                </div>
            ...
            <div className={styles.caption}>
                    ...
                    <h4>後村上天皇の御言葉</h4>
                        ...
                        八万の大兵を授けて正行公の元へ向かわせました。<br/><br/>
                        正行公も死を覚悟して吉野の行宮に参代し、 後村上天皇に
                        「この度は敵も精兵を集めて攻めて来ましたので、 私も生きるか死ぬかの大決戦を致します。
                        最後の思い出に陛下の お顔を拝してから参りとうございます」と申し上げ、 
                        天皇も「私はお前を自分の手足の如く思い頼っているのだから 決して無理な事はしないように」
                        と仰せられました。
                        </p>
                    <h4>如意輪堂</h4>
                        <p>
                        天皇のお言葉に正行公は感泣して退出し、先帝の後醍醐天皇の御陵を拝し、
                        次いで如意輪堂に行き、一族143名の名を留めて、<br/><br/>

                        　かえらじと　かねて思へば　あずさ弓<br/>
                        　なき数に入る　名をぞとどむる<br/><br/>
