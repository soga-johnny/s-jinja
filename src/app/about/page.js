...
export default function About (){
    ...
    return (
        ...
        title="四條畷神社について"
        description=
        "四條畷市は大阪府の東北部に位置し、市の約三分の二が北生駒山地でしめられている緑豊かな場所であり、西の軽井沢と称される。当社は飯盛山の山麓に鎮座し、忠孝両全の名将楠正行公をはじめ二十五柱の大神様をお祀りしている。"
        />
        <SubtitleVisual
        title="御由緒"
        description="　"
        ...
        <section className={styles.main}>
            ...
            <div className={styles.caption}>
                    ...
                    <h4>後村上天皇の御言葉</h4>
                        <p>
                        度々の敗戦に驚いた足利高氏は、腹心の高師直・師泰に八万の大兵を
                    ...
                    <h4>四條畷の決戦</h4>
                        ...
                        深野池の東北にて、弟正時と刺し違え23歳の若さにて殉節された。
