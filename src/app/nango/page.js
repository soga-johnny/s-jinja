            ...
            <div className={styles.item}>
                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.description}>
                        <p>大東市御領3-489</p>
                        <p>菅原道真公</p>
                        <p>由緒は不詳であるが、御領地域の開拓時氏神として祀ったものと思われる。
            ...
            <div className={styles.item}>
                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.description}>
                        <p>大東市新田東本町884</p>
                        <p>大山咋神</p>
                        <p>大東市には享保７（1722）年に江州（滋賀県）日吉神社より
            ...
            <div className={styles.item}>
                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.description}>
                        <p>大東市太子田2-130</p>
                        <p>天照皇大神</p>
                        <p>由緒は不詳であるが、文久3（1863）年に奉納された灯籠一対があり、
            ...
            <div className={styles.item}>
                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.description}>
                        <p>大東市諸福1-7-13</p>
                        <p>菅原道真公</p>
                        <p>御由緒　寛永20（1643）年、当地に勧請され社殿が建立されたとの記録が木札に記されている。
            ...
            <div className={styles.item}>
                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.description}>
                        <p>大東市御領1-253</p>
                        <p>龗神（おかみのかみ）</p>
                        <p>龗とは、「雨」と「口」と「龍」が合わさり一字となる難しい文字であるが、
                        いづれも農耕に係わることが分る。
